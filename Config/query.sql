...
degree varchar(50),fee int(10),department_id int(50),
CONSTRAINT fk_department_id FOREIGN KEY (department_id) REFERENCES departments(id));


CREATE TABLE patiants (id int(10) NOT NULL AUTO_INCREMENT PRIMARY KEY ,full_name varchar(50),email varchar(50),
password varchar(50),age int,weight varchar(10),gender varchar(50),address varchar(50),telephone varchar(50),
date_of_admit DATE,room_id int(50),disease varchar(50),doctor_id int(10),ssn_no varchar(50),
...
date_time_admitted DATE,advance int(50),total_bill int(50),FOREIGN KEY (patiant_id) REFERENCES patiants(id));


CREATE TABLE appointments (id int(10) NOT NULL AUTO_INCREMENT PRIMARY KEY ,patient_id varchar(50),
appointment_date varchar(50),appointment_time varchar(50),room_id varchar(50),doctor_id varchar(50),
consultancy_fee varchar(50),created varchar(50),appointment_status varchar(50),
FOREIGN KEY (patient_id) REFERENCES patiants(id),FOREIGN KEY (room_id) REFERENCES rooms(id),
