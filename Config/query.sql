...
appointment_date varchar(50),appointment_time varchar(50),room_id int(10),doctor_id int(10),
consultancy_fee varchar(50),created varchar(50),appointment_status varchar(50),
FOREIGN KEY (patient_id) REFERENCES patiants(id),
FOREIGN KEY (room_id) REFERENCES rooms(id), FOREIGN KEY (doctor_id) REFERENCES doctors(id));
